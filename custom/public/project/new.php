...
function llxHeaderVierge($title, $head = "", $disablejs = 0, $disablehead = 0, $arrayofjs = [], $arrayofcss = [])
{
	...
	background-image: url("/dolibarr/public/mybrand/img/background icon.jpg");
    ...
    .contact-left{
        ...
        background:url("/dolibarr/public/mybrand/img/pexels.jpg")
    ...
    .contact-right{
        flex:1 1 50%;                      /* NEW */
        padding:40px;                      /* Adjusted to match .contact-left */
        background:#fff;
    }
    .contact-right h2{
        margin-bottom:20px;
...
print '<style>
  ...
  /* Disable textarea resizing and set fixed sizes */
#address, #description {
    resize: none; /* Disables the resize handle */
    // min-height: 80px; /* Fixed minimum height for address */
    height: 50px; /* Fixed height for address */
    width: 100%;
    box-sizing: border-box;
}

/* Set different height for message textarea */
#description {
    min-height: 120px; /* Fixed minimum height for message */
    height: 120px; /* Fixed height for message */
}

/* Ensure consistent styling for all textareas */
.contact-right textarea {
    resize: none; /* Disable resizing for all textareas */
    font-family: inherit;
    font-size: 14px;
    line-height: 1.4;
}
...
print load_fiche_titre($langs->trans("Self Registration Form"), '', '', 0, '', 'center');
